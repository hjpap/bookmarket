...
public class AlterUserPwdServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AlterUserPwdServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ubb.alterPwd(user_id, newpwd)==1){
			...
			out.print("<script type='text/javascript'>window.alert('修改失败');location='alterpwd.jsp'</script>");
		}
	}
